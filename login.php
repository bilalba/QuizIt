...
if (isset($_POST['loginUsername'])) {
  ...
  $password = $_POST['loginPassword'];
      ...
      $rows = mysqli_num_rows($result);
        ...
        $score = getTotalScore($_SESSION['username']);
        $_SESSION['sessionStartScore'] = $score;
      ...
      <div class="container">
        <div class="form-outer text-center d-flex justify-content-center align-items-center">
          <div class="form-inner">
            ...
            <?php if (isset($_POST['loginUsername'])) { ?>
            ...
            <form action="" id="login-form" method="post" name= "login">
              ...
              </div><input id="login" name="submit" type="submit" class="btn btn-primary">
